...
export const USER_ROLES = ['admin','doctor','nurse','patient','pharmacist','lab_technician','radiologist'];
...
const userSchema = new mongoose.Schema(
    {
        ...
        role: { type: String, enum: USER_ROLES, default: 'patient', required: true },
