export const createPageStyles = {
    ...
    form: { background: '#ffffff', border: '1px solid #e2e8f0', borderRadius: '18px', padding: '24px', display: 'grid', gap: '16px', maxWidth: '920px' },
    ...
    input: { width: '100%', boxSizing: 'border-box', border: '1px solid #cbd5e1', borderRadius: '10px', padding: '11px 12px', color: '#0f172a', background: '#ffffff' },
    textarea: { width: '100%', boxSizing: 'border-box', border: '1px solid #cbd5e1', borderRadius: '10px', padding: '11px 12px', color: '#0f172a', background: '#ffffff', minHeight: '110px', resize: 'vertical' },
    section: { border: '1px solid #dbeafe', borderRadius: '14px', padding: '16px', background: '#f8fbff' },
    sectionTitle: { margin: '0 0 12px', fontSize: '20px', color: '#0f172a' },
    row: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '12px', marginBottom: '12px' },
    primaryButton: { border: 'none', background: '#2563eb', color: '#ffffff', padding: '12px 16px', borderRadius: '10px', fontWeight: 800, cursor: 'pointer' },
